...
public class BinanceFuturesMarket implements FuturesMarket {
    ...
    /**
     * Fetches historical 5m candles for the specified asset pair from Binance Futures REST API.
    ...
    public reactor.core.publisher.Flux<com.tradingbot.model.Candle> fetchHistory(java.lang.String symbol, int days) {
        ...
        System.out.println("[BINANCE FUTURES MARKET] Fetching warm-up history for symbol: " + symbol);
        ...
        return this.webClient.get()
                ...
                .onErrorResume(e -> {
                    System.err.println("[BINANCE FUTURES ERROR] Failed to fetch history for " + symbol + ": " + e.getMessage());
